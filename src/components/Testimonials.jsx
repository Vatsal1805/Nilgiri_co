    ...
    <section id="testimonials" className="testimonials">
      <div className="container" data-reveal="fade">
        ...
        <div className="testimonials__header" data-reveal="scale">
          ...
          <h2 className="testimonials__heading">Reviews &amp; Chronicles</h2>
        </div>

        {/* ── Slider Wrapper ── */}
        <div className="testimonials__slider-wrap" data-reveal="fade">
          {/* Left Arrow */}
          ...
          <div className="testimonials__track-container">
            ...
            >
              {REVIEWS.map((review, i) => (
                <div key={i} className={`testimonials__card ${i === activeIndex + 1 ? 'is-active' : ''}`}>
